...
\section{Herramientas y tecnologías}\label{sec:tecnoloxias}

\subsection{Tecnología 1: VSCode}\label{subsec:tecnoloxia1}
...
No conocía esta tecnología, porque durante el grado habíamos usado otra herramienta (Taiga) para gestionar los \textit{Sprints}, pero claramente resultó útil para orquestar el flujo de trabajo de un equipo de más de 10 personas.

\subsection{Tecnología 4: Modelos CLIP}\label{subsec:tecnoloxia4}
...
\subsection{Tecnología 5: uv}\label{subsec:tecnoloxia5}

uv \footnote{https://docs.astral.sh/uv/} es una herramienta ligera escrita en Rust para gestionar proyectos de Python. En el proyecto utilizamos esta tecnología para gestionar las dependencias y compilar el paquete.
