\chapter{Desenvolvemento da práctica}
...
\subsubsection{Soluciones alternativas (4 días)}\label{subsubsec:results}
...
\subsubsection{Documentación (2 días)}\label{subsubsec:results}
...
\subsubsection{Preparar y construir el paquete (1 día)}\label{subsubsec:results}
